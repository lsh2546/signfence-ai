...
const contract: ContractData = { partyA:'A', partyB:'B', amount:1200, paymentScheduleAmount:1200, effectiveDate:'2026-09-01', dueDate:'2026-09-30', obligations:['10 images'], copyrightTransferCondition:'Only after full payment', requiredClauses:['scope','payment','delivery','copyright'], extraClauses:[] };
